Pod::Spec.new do |spec|
  ...
  spec.description     = 'The Appsfire SDK for iOS enables you to natively monetize your application and engage with your userspec.'
  spec.homepage        = 'https://appsfire.com/'
  spec.author          = { 'Appsfire' => 'https://appsfire.com/' }
  spec.source          = { :git => 'https://github.com/appsfire/Appsfire-iOS-SDK.git', :tag => '2.2' }
