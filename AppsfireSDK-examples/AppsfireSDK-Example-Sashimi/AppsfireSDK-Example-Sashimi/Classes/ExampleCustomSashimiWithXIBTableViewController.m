//
//  ExampleCustomSashimiWithXIBTableViewController.m
...
@interface ExampleCustomSashimiWithXIBTableViewController ()
...
@implementation ExampleCustomSashimiWithXIBTableViewController
...
- (BOOL)_includeSashimiIfAvailable {
    ...
    sashimiAdsCount = [AppsfireAdSDK numberOfSashimiAdsAvailableForNibName:@"ExampleCustomSashimiView" forZone:@"/3180317/square/af"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    // determine cell id
    celluid = ([sourceObject isKindOfClass:[NSString class]] && [sourceObject isEqualToString:@"sashimi"]) ? @"sashimi-custom" : @"classic";
    ...
    if (cell == nil) {
        ...
        // create cell
        if ([celluid isEqualToString:@"sashimi-custom"])
            cell = [[ExampleCustomSashimiWithXIBTableViewCell alloc ] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:celluid];
        else {
