/*!
 *  AFAdMobBannerViewCustomEvent.m
 *  Copyright (c) 2014 Appsfire. All rights reserved.
 */

#import "AFAdMobBannerViewCustomEvent.h"

// AdMob
#import "GADBannerView.h"

@interface AFAdMobBannerViewCustomEvent () <GADBannerViewDelegate>
...
@implementation AFAdMobBannerViewCustomEvent
...
- (void)requestBannerViewWithSize:(CGSize)size customEventParameters:(NSDictionary *)parameters {
    ...
    self.bannerView = [[GADBannerView alloc] initWithAdSize:GADAdSizeFromCGSize(size)];
