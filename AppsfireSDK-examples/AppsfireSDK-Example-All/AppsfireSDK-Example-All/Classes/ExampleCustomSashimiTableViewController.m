//
//  ExampleCustomSashimiTableViewController.m
...
@interface ExampleCustomSashimiTableViewController () {
...
@implementation ExampleCustomSashimiTableViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (cell == nil) {
        ...
        if ([celluid isEqualToString:@"sashimi-custom"])
            cell = [[ExampleCustomSashimiTableViewCell alloc ] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:celluid];
        else {
