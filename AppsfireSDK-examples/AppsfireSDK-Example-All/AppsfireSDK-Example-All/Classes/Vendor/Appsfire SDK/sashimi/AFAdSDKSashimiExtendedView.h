...
/*!
 * Color of the border around the app icon in `AFAdSDKSashimiExtendedStyleModeLight` style mode.
 *
 * @since 2.2.0
 */
...
/*!
 * Color of the border around the app icon in `AFAdSDKSashimiExtendedStyleModeDark` style mode.
 *
 * @since 2.2.0
 */
